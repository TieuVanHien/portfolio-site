...
export const Home = () => {
  return (
    ...
    >
      ...
      <div className="left w-full h-45vh flex p-0 m-0 justify-center items-center lg:h-full lg:max-h-[85%] xl:max-h-[65%] lg:w-3/5 lg:flex lg:justify-center lg:items-center">
        <RoboModel />
      </div>
    </section>
  );
